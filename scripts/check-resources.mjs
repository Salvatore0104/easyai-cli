...
if (process.argv.includes('--update')) {
  await writeFile(lockPath, JSON.stringify({ schemaVersion: 'wowidea.resources/v1', version: '0.4.0', textNormalization: 'UTF-8 with LF line endings; binary files hashed verbatim', files: hashes }, null, 2) + '\n');
} else {
